...
namespace ZYNLPJPT.DAL
{
	...
	public partial class ST_DAL
	{
		...
		public int Add(ZYNLPJPT.Model.ST model)
		{
			...
			strSql.Append("KCBH,CTSJ,TMNR,TMDA,CTR,SFZDYJ,SFSC)");
		...
		public ZYNLPJPT.Model.ST GetModel(int STBH)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 STBH,KCBH,CTSJ,TMNR,TMDA,CTR,SFZDYJ,SFSC from ST ");
			strSql.Append(" where STBH=@STBH");
			SqlParameter[] parameters = {
					new SqlParameter("@STBH", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select STBH,KCBH,CTSJ,TMNR,TMDA,CTR,SFZDYJ,SFSC ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" STBH,KCBH,CTSJ,TMNR,TMDA,CTR,SFZDYJ,SFSC ");
			strSql.Append(" FROM ST ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
