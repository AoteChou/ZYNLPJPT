<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XiuGaiXS.aspx.cs" Inherits="ZYNLPJPT.XiuGaiXS" %>
...
<body class="easyui-layout">
    <form action="XiuGaiXS.aspx" method="post">
         ...
         <tbody>
            <%
                for (int i = 0; i < this.bjbh.Length; i++)
                {
                    ...
                    Response.Write("  <td><a id=\"A1\" href=\"javascript:void(0)\" class=\"easyui-linkbutton\" style=\"margin-top:10px; margin-bottom:10px;\" onclick=\"window.location.href='processAspx/XiuGaiXS1.aspx?bjbh=" + bjbh[i] + "'\" >进入修改</a></td>");
                    Response.Write("</tr>");
                }
