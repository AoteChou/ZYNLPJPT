<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ckctjl.aspx.cs" Inherits="ZYNLPJPT.ckctjl" %>
...
<body class="easyui-layout">
   ...
   <%
                  for (int i = 0; i < this.num; i++)
                  {
                      ...
                      Response.Write("  <td><a id=\"A1\" href=\"javascript:void(0)\" class=\"easyui-linkbutton\" style=\"margin-top:10px; margin-bottom:10px;\" onclick=\"window.location.href='kcctRecord.aspx?kcbh=" + ctview[i].KCBH + "'\" >查看</a></td>");
                      Response.Write("</tr>");
                  }
   %>
            </tbody>
