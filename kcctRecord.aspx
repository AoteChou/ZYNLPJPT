<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kcctRecord.aspx.cs" Inherits="ZYNLPJPT.kcctRecord" %>
...
<body class="easyui-layout">
    <div region="center" border="false">
      ...
      <div region="center" border="false">
      <div style="padding:10px 10px 10px 400px"  region="center">
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="window.location.href='ckctjl.aspx'">返回上页</a>
      </div>
    </div>
