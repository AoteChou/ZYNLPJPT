<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pzjsgt.aspx.cs" Inherits="ZYNLPJPT.pzjsgt" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>配置阶段课程改题人</title>
...
<form action="pzjsgt.aspx" method="post">
  ...
  <table id="mytable" class="easyui-datagrid"  fit="true" data-options="fitColumns:true" style="border:none;" border="false">
    	<thead>
    		<tr>
                ...
                <th data-options="field:'button',align:'center'" width="40">配置改题人</th>
    		</tr>
    	</thead>
   		<tbody >
              <%
