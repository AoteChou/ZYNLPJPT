   		...
   		<tbody >
              <%
                   for (int i = 0; i < this.xyXkZyViews.Length; i++)
                   {
                       ...
                       Response.Write("  <td><a id=\"A1\" href=\"#\" class=\"easyui-linkbutton\" style=\"margin-top:10px; margin-bottom:10px;\" onclick=\"window.location.href='processAspx/pzEjzbProc.aspx?zybh=" + xyXkZyViews[i].ZYBH  + "'\" >配置专业能力指标</a></td>");
                       Response.Write("</tr>");
                   }
                    %>
    	</tbody>
