<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pzzykc.aspx.cs" Inherits="ZYNLPJPT.pzzykc" %>
...
<body class="easyui-layout">
    ...
    <form action="pzzykc.aspx" method="post">
         ...
         <tbody>
            <%
                for (int i = 0; i < this.zykcViews.Length; i++)
                {
                    ...
                    Response.Write("  <td><a id=\"A1\" href=\"javascript:void(0)\" class=\"easyui-linkbutton\" style=\"margin-top:10px; margin-bottom:10px;\" onclick=\"window.location.href='processAspx/zykcData.aspx?zybh=" + this.zykcViews[i].ZYBH + "'\" >配置专业课程</a></td>");
                    Response.Write("</tr>");
                }
