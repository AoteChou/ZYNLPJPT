<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="scjsgt.aspx.cs" Inherits="ZYNLPJPT.scjsgt" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>删除阶段课程改题人</title>
    ...
    <script type="text/javascript">
        function deleteAllGtr(jdbh, njbh, zybh, kcbh) {
            $.post("processAspx/DelAllGtr.aspx", { 'jdbh': jdbh, 'njbh': njbh,'zybh':zybh,'kcbh':kcbh }, function (result) {
                if (result == 'False') {
...
<div region="center" border="false">
 <div id="ctTea" class="easyui-window" title="删除出题人" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:200px;padding:10px;">
 </div>
  <table id="mytable" class="easyui-datagrid"  fit="true" data-options="fitColumns:true" style="border:none;" border="false">
    	<thead>
    		<tr>
                ...
                <th data-options="field:'buttonAll',align:'center'" width="50">删除所有改题人</th>
                <th data-options="field:'buttonSingle',align:'center'" width="50">删除单个改题人</th>
    		</tr>
    	</thead>
   		<tbody >
              <%
                   for (int i = 0; i < this.jdkcViews.Length; i++)
                   {
                       ...
                       Response.Write("  <td><a id=\"A1\" href=\"javascript:void(0)\" class=\"easyui-linkbutton\" style=\"margin-top:10px; margin-bottom:10px;\" onclick=\" deleteAllGtr(" + jdkcViews[i].JDBH + "," + jdkcViews[i].NJBH + "," + jdkcViews[i].ZYBH + "," + jdkcViews[i].KCBH + ") \" >删除所有改题人</a></td>");
                       Response.Write("  <td><a id=\"A1\" href=\"javascript:void(0)\" class=\"easyui-linkbutton\" style=\"margin-top:10px; margin-bottom:10px;\" onclick=\"window.location.href='processAspx/scjdkcxsProc.aspx?njbh=" + this.jdkcViews[i].NJBH + "&jdbh=" + this.jdkcViews[i].JDBH + "&kcbh=" + jdkcViews[i].KCBH + "&zybh=" + jdkcViews[i].ZYBH + "&xkbh=" + jdkcViews[i].XKBH + "'\" >删除单个改题人</a></td>");
                       Response.Write("</tr>");
                   }
                 %>
    	</tbody>
