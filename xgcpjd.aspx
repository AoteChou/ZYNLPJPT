<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xgcpjd.aspx.cs" Inherits="ZYNLPJPT.xgcpjd" %>
...
<div region="center" border="false">
 <div id="ctTea" class="easyui-window" title="修改测评阶段" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:200px;padding:10px;">
 </div>
