<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xgejzb.aspx.cs" Inherits="ZYNLPJPT.xgejzb" %>
...
<div region="center" border="false">
 <div id="ctTea" class="easyui-window" title="修改二级指标" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:200px;padding:10px;">
</div>
  <table id="mytable" class="easyui-datagrid"  fit="true" data-options="fitColumns:true" style="border:none;" border="false">
    	<thead>
    		<tr>
                ...
                <th data-options="field:'button',align:'center'" width="20">修改二级指标</th>
    		</tr>
    	</thead>
   		<tbody >
              <%
                  for (int i = 0; i < this.nlzbViewWrappers.Length; i++)
                  {
                      ...
                      Response.Write("  <td><a id=\"A1\" href=\"javascript:void(0)\" class=\"easyui-linkbutton\" style=\"margin-top:10px; margin-bottom:10px;\" onclick=\"window.location.href='processAspx/xgejzbData.aspx?ejzbbh=" +nlzbViewWrappers[i].NlzbView.EJZBBH + "&ejzbmc=" +nlzbViewWrappers[i].NlzbView.EJZBMC +"&yjzbmc="+nlzbViewWrappers[i].NlzbView.YJZBMC + "'\" >修改二级指标</a></td>");
                      Response.Write("</tr>");
                  }
                   %>
    	</tbody>
