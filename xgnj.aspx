<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xgnj.aspx.cs" Inherits="ZYNLPJPT.xgnj" %>
   		...
   		<tbody >
              <%
                   for (int i = 0; i < this.njs.Length; i++)
                   {
                       ...
                       Response.Write("  <td><a id=\"A1\" href=\"javascript:void(0)\" class=\"easyui-linkbutton\" style=\"margin-top:10px; margin-bottom:10px;\" onclick=\"window.location.href='processAspx/xgnjData.aspx?njbh=" + njs[i].NJBH + "&njmc=" + njs[i].NJMC + "&rxnf=" + njs[i].RXNF.ToShortDateString() + "'\" >修改年级信息</a></td>");
                       Response.Write("</tr>");
                   } %>
    	</tbody>
   	</table>     
