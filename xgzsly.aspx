<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xgzsly.aspx.cs" Inherits="ZYNLPJPT.xgzsly" %>
...
<div region="center" border="false">
 <div id="ctTea" class="easyui-window" title="修改知识领域" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:200px;padding:10px;">
</div>
  <table id="mytable" class="easyui-datagrid"  fit="true" data-options="fitColumns:true" style="border:none;" border="false">
    	<thead>
    		<tr>
                ...
                <th data-options="field:'button',align:'center'" width="30">修改知识领域</th>
    		</tr>
    	</thead>
   		<tbody >
              <%
                   for (int i = 0; i < this.zslyDetails.Length; i++)
                   {
                       ...
                       Response.Write("  <td><a id=\"A1\" href=\"javascript:void(0)\" class=\"easyui-linkbutton\" style=\"margin-top:10px; margin-bottom:10px;\" onclick=\"window.location.href='processAspx/xgzslyData.aspx?zslybh=" + this.zslyDetails[i].Zsly.ZSLYBH + "&zslymc=" + zslyDetails[i].Zsly.ZSLYMC + "&bz=" +zslyDetails[i].Zsly.BZ+"&xkbh="+zslyDetails[i].Zsly.XKBH+ "'\" >修改知识领域</a></td>");
                       Response.Write("</tr>");
                   }
                   %>
    	</tbody>
