<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xiugaiZYKC1.aspx.cs" Inherits="ZYNLPJPT.xiugaiZYKC1" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function getSelections(zybh) {
            ...
            if (flag) {
                if (kcbh.length > 0) {
                    $.post("processAspx/xiugaiZYKC2.aspx", { 'kcbh': kcbh, 'zybh': zybh, 'kkxqbh': kkxqbh, 'kcxzbh': kcxzbh, 'llxf': llxf, 'sjxf': sjxf }, function (result) {
                        if (result == 'False') {
   		...
   		<tbody >
              <%
                   for (int i = 0; i < this.kcbh.Length; i++)
                   {
                       ...
                       Response.Write("	<td >" + kkxq[i] + "</td>");
                       Response.Write("	<td >" + kcxzbh[i] + "</td>");
